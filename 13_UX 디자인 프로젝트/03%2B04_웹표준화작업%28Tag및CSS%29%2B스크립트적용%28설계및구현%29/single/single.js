...
$(document).ready(function(){
	...
	$(window).on("load resize",function(){
		...
		if ($("html,body").css("max-width")<=480)
		{
			$(window).scroll(function(){
			if ($(this).scrollTop()>=hh/4)
			{
				$(".fixgnb").slideDown(100);
			} else {
				$(".fixgnb").slideUp(100);
			}
		});//scroll header fixed
		...
		$(".header .fixgnb li a,.mmenu ul li a").click(function(){
		...
		$(window).scroll(function(){
			...
			{
				$(".header .fixgnb li a, .mmenu ul li a").eq(6).addClass("active").parents().siblings().find("a").removeClass("active");
				$(".pagi .pbar").eq(6).addClass("activePagi").siblings().removeClass("activePagi");
			} else if ($(this).scrollTop()>=hh1+hh2+hh3+hh4+hh5)
			{
				$(".header .fixgnb li a, .mmenu ul li a").eq(5).addClass("active").parents().siblings().find("a").removeClass("active");
				$(".pagi .pbar").eq(5).addClass("activePagi").siblings().removeClass("activePagi");
			} else if ($(this).scrollTop()>=hh1+hh2+hh3+hh4)
			{
				$(".header .fixgnb li a, .mmenu ul li a").eq(4).addClass("active").parents().siblings().find("a").removeClass("active");
				$(".pagi .pbar").eq(4).addClass("activePagi").siblings().removeClass("activePagi");
			} else if ($(this).scrollTop()>=hh1+hh2+hh3)
			{
				$(".header .fixgnb li a, .mmenu ul li a").eq(3).addClass("active").parents().siblings().find("a").removeClass("active");
				$(".pagi .pbar").eq(3).addClass("activePagi").siblings().removeClass("activePagi");
			} else if ($(this).scrollTop()>=hh1+hh2)
			{
				$(".header .fixgnb li a, .mmenu ul li a").eq(2).addClass("active").parents().siblings().find("a").removeClass("active");
				$(".pagi .pbar").eq(2).addClass("activePagi").siblings().removeClass("activePagi");
			} else if ($(this).scrollTop()>=hh1)
			{
				$(".header .fixgnb li a, .mmenu ul li a").eq(1).addClass("active").parents().siblings().find("a").removeClass("active");
				$(".pagi .pbar").eq(1).addClass("activePagi").siblings().removeClass("activePagi");
			} else if ($(this).scrollTop()<hh1)
			{
				$(".header .fixgnb li a, .mmenu ul li a").eq(0).addClass("active").parents().siblings().find("a").removeClass("active");
		...
		$(window).scroll(function(){
			if ($(this).scrollTop()>=hh1+hh2+hh3+hh4+hh5+hh6/1.3)
			{
			...
			} else if ($(this).scrollTop()>=hh1+hh2+hh3+hh4/1.3)
			{
			...
			} else if ($(this).scrollTop()>=hh1+hh2/1.3)
			{
				$(".section .beer .beerwrap").css({"opacity":1,"transition":"0.8s","bottom":0});
				
			} else if ($(this).scrollTop()>=hh1/1.3)
			{
